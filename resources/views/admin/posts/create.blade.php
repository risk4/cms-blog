...
<div class="space-y-6">
    ...
    <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
            ...
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Add a new post to your website</p>
        </div>
        <nav>
            <ol class="flex items-center gap-2">
                ...
                <li class="text-sm font-medium text-brand-600 dark:text-brand-400">Create</li>
            </ol>
        </nav>
    </div>
        ...
        <div class="grid grid-cols-1 gap-6 xl:grid-cols-3">
                ...
                <div class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
                    ...
                    <div class="space-y-5">
                        ...
                        <div>
                            ...
                            <input type="text" id="title" name="title" value="{{ old('title') }}" placeholder="Enter post title" class="w-full rounded-lg border border-gray-300 bg-white px-4 py-2.5 text-sm text-gray-900 placeholder-gray-400 focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-500 @error('title') border-red-500 focus:border-red-500 focus:ring-red-500 @enderror" required>
                            @error('title')
                        ...
                        <div>
                            ...
                            <input type="text" id="slug" name="slug" value="{{ old('slug') }}" placeholder="Auto-generated from title" class="w-full rounded-lg border border-gray-300 bg-white px-4 py-2.5 text-sm text-gray-900 placeholder-gray-400 focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-500 @error('slug') border-red-500 focus:border-red-500 focus:ring-red-500 @enderror">
                            @error('slug')
                                <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                            @enderror
                        </div>
            ...
            <div class="xl:col-span-1 space-y-6">
                ...
                <div class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
                    ...
                    <div x-data="{ featured: {{ old('is_featured') ? 'true' : 'false' }}, slider: {{ old('is_slider') ? 'true' : 'false' }} }" class="space-y-5">
                        <!-- Category -->
                        <div>
                        ...
                        <div>
                            ...
                            <input type="datetime-local" id="published_at" name="published_at" value="{{ old('published_at') }}" class="w-full rounded-lg border border-gray-300 bg-white px-4 py-2.5 text-sm text-gray-900 placeholder-gray-400 focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-500 @error('published_at') border-red-500 focus:border-red-500 focus:ring-red-500 @enderror">
                            @error('published_at')
                                <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="rounded-lg border border-gray-100 bg-gray-50 p-3 dark:border-gray-600 dark:bg-gray-700/50">
                            <div class="flex items-center justify-between">
                                ...
                                <button type="button" @click="featured = !featured"
                                        ...
                                        class="relative inline-flex h-8 w-14 shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-4 focus:ring-brand-300 dark:focus:ring-brand-800 p-1">
                                    <span :class="featured ? 'translate-x-6' : 'translate-x-0'"
                                          class="pointer-events-none inline-block h-6 w-6 transform rounded-full bg-white shadow-md transition duration-200 ease-in-out">
                                    </span>
                                </button>
                ...
                <div class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <div class="flex items-center justify-center rounded-lg border-2 border-dashed border-gray-300 bg-gray-50 p-6 dark:border-gray-600 dark:bg-gray-700/50">
                                <div class="text-center">
                                    ...
                                    <svg id="featured_image_placeholder" class="mx-auto h-12 w-12 text-gray-400" fill="none" viewBox="0 0 24 24" stroke-width="1" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="m2.25 15.75 5.159-5.159a2.25 2.25 0 0 1 3.182 0l5.159 5.159m-1.5-1.5 1.409-1.409a2.25 2.25 0 0 1 3.182 0l2.909 2.909m-18 3.75h16.5a1.5 1.5 0 0 0 1.5-1.5V6a1.5 1.5 0 0 0-1.5-1.5H3.75A1.5 1.5 0 0 0 2.25 6v12a1.5 1.5 0 0 0 1.5 1.5Zm10.5-11.25h.008v.008h-.008V8.25Zm.375 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Z" />
                                    </svg>
                                    <p id="featured_image_text" class="mt-2 text-sm text-gray-500 dark:text-gray-400">No image chosen</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <!-- Upload -->
                        <div>
                            <label for="featured_image" class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-300">Upload Image</label>
                            ...
                            @error('featured_image')
                                <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                            @enderror
                            <p class="mt-1.5 text-xs text-gray-500 dark:text-gray-400">Recommended: 1200x630px.</p>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    ...
    const featuredPlaceholder = document.getElementById('featured_image_placeholder');
    const featuredText = document.getElementById('featured_image_text');
    ...
    if (featuredInput) {
        featuredInput.addEventListener('change', function(e) {
            ...
            if (file) {
                if (featuredFilename) featuredFilename.textContent = file.name;
                ...
                reader.onload = function(event) {
                    ...
                    if (featuredText) featuredText.classList.add('hidden');
                };
